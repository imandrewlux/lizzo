...
function setup() {
  ...
  //lyrics
  lyrics = [
    { beat: 32, lyric: "Mirror, mirror on the wall" },
    ...
    {
      beat: 65,
      lyric: "If I'm shiny, everybody gonna shine (Yeah, I'm goals)"
    },
    {
      beat: 73,
      lyric: "I was born like this, don't even gotta try (Now you know)"
    },
    {
      beat: 80,
      lyric: "I like chardonnay, get better over time (So you know)"
    },
    ...
    {
      beat: 136,
      lyric: "Blame it on my juice, blame it, blame it on my juice"
    },
    { beat: 142, lyric: "Ya-ya-ee, ya-ya-ee, ya-ya-ee, ya-ya-ee" },
    {
      beat: 151,
      lyric: "Blame it on my juice, blame it, blame it on my juice (Ooh, baby)"
    },
    ...
    {
      beat: 217,
      lyric: "Heard you say I'm not the baddest, bitch, you lie (You lie)"
    },
    ...
    {
      beat: 279,
      lyric: "Blame it on my juice, blame it, blame it on my juice (Alright)"
    },
